      ...
      >
        ...
        <div className="header" style={{ marginTop: "5vh" }}>
          ...
          {isTabletOrMobileDevice ? (
            // Mobile
            <>
              <h1 style={{ fontSize: "calc((.2em + 3vmin) + (.2em + 31vmax))", padding: 50, paddingBottom: 30 }}>
            One platform to secure all your websites.
              ...
              <p style={{fontSize: "3.7vw", width: "100vw", marginTop: '1vh', marginBottom: 0}}>
              30,000 websites are hacked every day. 
              </p>
              <p style={{ fontSize: "3.7vw", width: "100vw", marginTop: '1vh'}}>
           Over 10 thousand sites are
            ...
            One platform to secure all your websites.
              ...
              <h3
                style={{
                  fontSize: "calc((.13em + 1.4vmin) + (.13em + 1.3vmax))",
                }}
              >
                Backup & Restore in ONE CLICK.
              </h3>
          ...
          <div className="twoop">
            {isTabletOrMobileDevice ? (
              ...
              <>
                <ul style={{paddingLeft: 20}}>
                  <li style={{width: '70%'}}>
                    <div style={{ color: "#ffffff", fontSize: '3.6vw', width: '100%' , paddingRight: 0}}>
            ...
            <Link href="/pricing">
              <button style={{ cursor: "pointer" , marginTop: '4vh'}}>Secure my website</button>
            </Link>
          </div>
              </>
            ) : (
              ...
              <>
                <ul style={{ marginBottom: 0}}>
                  ...
                  <li style={{textAlign: "left",}}>
                    <img src="img/tick.png" />
                    <p style={{ color: "#ffffff", marginTop: 0 }}>Cancel anytime</p>
                  </li>
                </ul>
                <div className="secbtn">
            <Link href="/pricing">
